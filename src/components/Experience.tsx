          ...
          >
            ...
            <ul className="space-y-2 mb-6 text-[#434656] text-sm md:text-base leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>Ditempatkan di <strong>Departemen Small WO</strong> — departemen yang menangani pengemasan (packing) komponen dan alat-alat kecil milik PT Esco Indonesia.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#0052ff] font-bold select-none">•</span>
                <span>Menggunakan <strong>Microsoft Excel & Word</strong> untuk pencatatan dan pendataan stok barang di gudang secara rutin.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#0052ff] font-bold select-none">•</span>
                <span>Mendapatkan pengalaman langsung tentang <strong>dunia kerja nyata</strong> — kedisiplinan, tanggung jawab, dan etika profesional di lingkungan industri.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#0052ff] font-bold select-none">•</span>
